        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
                    <div class="h-entry">
                        <h2>عن الصندوق</h2>
                        <p class="mb-4">توثيقا لأواصر المحبة و تحقيقا لمبدأ التعاون على البر والتقوى فقد ارتأت نخبة من رجال عائلة الهجــاري الغيورين على مصلحتها ، بعد لقاءات مباركة فيما بينهم ، مسيس الحاجة لإنشاء صندوق خيري لها يكثف جهودها لمساعدة بعضها البعض</p>
                    </div>
                </div>
